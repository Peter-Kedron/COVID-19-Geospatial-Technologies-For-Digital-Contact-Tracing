...
datatable(data_table, colnames = c("State", "__Ignored__", "__Ignored__", "App Planned", "App Released As Of Review", "If No, Last Mentioned", "App Name", "Technology Used", "Developers"), rownames = FALSE, options=list(columnDefs = list(list(visible=FALSE, targets=c(1, 2, 9, 10)))))
```
